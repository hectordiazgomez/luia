    ...
    return (
        <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-25 flex items-center justify-center">
            <div className="bg-white px-20 flex flex-col rounded-lg p-8">
                <Link to="/writingeasy"><button className="mb-4 bg-gray-200 w-full font-semibold mb-4 py-2 rounded text-blue-500">Easy</button></Link>
                <Link to="/writingmedium"><button className="mb-4 bg-gray-200 px-7 font-semibold mb-4 py-2 rounded text-blue-500">Medium</button></Link>
                <Link to="/writinghard"><button className="mb-4 bg-gray-200 w-full font-semibold py-2 rounded text-blue-500">Hard</button></Link>
